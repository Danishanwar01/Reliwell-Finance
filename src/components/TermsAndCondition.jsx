...
const TermsAndConditions = () => {
  ...
  return (
    <div style={containerStyle}>
      ...
      <h2 style={sectionTitleStyle}>Using Our Service / Buying Coins</h2>
      <p>
      ...
      <p>
        Security is important to Reliwell, and you therefore agree not to share your wallet access with any other user or third party, or knowingly carry out any activity which enables a third party to access or use your account. If we believe, acting in our discretion, that your account is used inappropriately, we reserve the right to suspend or terminate or cease to support your account without liability.
      </p>
      <p>
        We cannot check the identities of people using our Services and will not be liable if your wallet connection or account is used by someone else. If you become aware of any unauthorised use of your login, you should notify us immediately by contacting us at{' '}
        <a href="mailto:admin@Reliwell.com" style={linkStyle}>
          admin@Reliwell.com
        </a>
        , using 'Security Breach' as the subject line. Please note that we may need to verify your identity and validate ownership of the account. Be alert for other websites and services which may pretend to be us or to be associated with us.
      </p>

      <h2 style={sectionTitleStyle}>Removing Data</h2>
      <p>
      ...
      <h2 style={sectionTitleStyle}>Rules of Use</h2>
      ...
      <h2 style={sectionTitleStyle}>Violation of Rules</h2>
      <p>
      ...
      <p>
        We cannot guarantee that other users will comply with these Rules, and we will not be responsible for any other user's lack of compliance. You and other users are responsible for your own actions.
      </p>

      <h2 style={sectionTitleStyle}>Service Interruption</h2>
      <p>
        Reliwell does not guarantee that the Services will always be available, uninterrupted, timely, secure, or free from bugs or viruses. There may be times when the Services are unavailable due to maintenance or technical issues. We may also change, suspend, or discontinue certain Services without giving you prior notice.
      </p>
      <p>
      ...
      <h2 style={sectionTitleStyle}>Prohibited Person</h2>
      <p>
      ...
      <h2 style={sectionTitleStyle}>Third Parties</h2>
      <p>
        Some pages may link to third-party websites or services. These links are provided for convenience, and Reliwell is not responsible for any third-party content. If you visit any third-party website, please be aware that it may have its own terms of use and privacy policy.
      </p>

      <h2 style={sectionTitleStyle}>Agreeing to Terms</h2>
      <p>
      ...
      <p>
        Our services are not available for use by children under the age of 18 years old or 21 years old in some jurisdictions. Please refer to your country’s laws for age-related guidance.
      </p>

      <h2 style={sectionTitleStyle}>Content and IP Rights</h2>
      <p>
        All content and information contained in the Services are owned or licensed by Reliwell and are protected by intellectual property rights. You may not use, copy, reverse engineer, or modify any content without explicit permission.
      </p>

      <h2 style={sectionTitleStyle}>Additional Important Information</h2>
      <p>
      ...
      <ul>
        ...
        <li>We make no guarantees regarding the accuracy, completeness, or timeliness of the content on our site.</li>
